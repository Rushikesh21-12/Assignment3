    ...
    <View style={styles.mainContainer}>
      <View style={styles.container}>
        ...
        <Forminput
          ...
          onChangeText={value =>
            onChangeTextInput(value, 'userName', setErrorUserName)
          }
        ...
        <Forminput
          ...
          onChangeText={value =>
            onChangeTextInput(value, 'password', setErrorPassword)
          }
        ...
        <View style={styles.button}>
          <Button testID='loginButton' title="Login" onPress={onSignin} />
        </View>

        <TouchableOpacity
          onPress={() => navigation.navigate('ForgotPasswordScreen')}>
          <Text testID="abc" style={styles.lastText}>
            Forgot your login details?{' '}
            <Text style={styles.lastBoldText}>Get help logging in.</Text>
          </Text>
        </TouchableOpacity>
      </View>
      ...
      <TouchableOpacity
        ...
        <Text style={styles.lastText}>
          ...
          <Text style={styles.lastBoldText}>Sign Up.</Text>
        </Text>
      </TouchableOpacity>
    </View>
  );
